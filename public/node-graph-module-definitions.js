...
const nodeGraphModuleDefinitions = Object.freeze({
  ...
  creature: {
    displayType: "trace",
    displayModes: [
      { key: "hungerTrace", label: "Hunger Trace", renderer: "trace", settingsSchema: "trace", source: { value: "Hunger" } },
      { key: "healthTrace", label: "Health Trace", renderer: "trace", settingsSchema: "trace", source: { value: "Health" } },
      { key: "moodTrace", label: "Mood Trace", renderer: "trace", settingsSchema: "trace", source: { value: "Mood" } },
    ],
    defaultDisplayMode: "hungerTrace",
    displaySignals: [
      { key: "Hunger", kind: "scalar" },
  ...
  cellularAutomaton: {
    displayType: "scope2d",
    displaySignals: [
      { key: "Density", kind: "scalar" },
      { key: "Activity", kind: "scalar" },
      { key: "X", kind: "scalar" },
      { key: "Y", kind: "scalar" },
      { key: "X/Y", kind: "xy" },
    ],
    displayModes: [
      { key: "xyBurn", label: "Spacetime Burn", renderer: "scope2d", settingsSchema: "scope2d", source: { x: "X", y: "Y" } },
      { key: "xyTrace", label: "Spacetime Trace", renderer: "scope2dTrace", settingsSchema: "scope2dTrace", source: { x: "X", y: "Y" } },
    ],
    defaultDisplayMode: "xyBurn",
    inputs: ["Reset"],
