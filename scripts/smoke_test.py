...
def require_native_module_contract(base_url: str) -> None:
    ...
    expected_native_exports = {
        ...
        "cellular_automaton": [
            "soemdsp_cellular_automaton_create",
            "soemdsp_cellular_automaton_destroy",
            "soemdsp_cellular_automaton_process",
            "soemdsp_cellular_automaton_density",
            "soemdsp_cellular_automaton_activity",
            "soemdsp_cellular_automaton_x",
            "soemdsp_cellular_automaton_y",
            "soemdsp_cellular_automaton_metadata_json",
        ],
